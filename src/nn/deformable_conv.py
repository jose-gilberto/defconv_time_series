...
#         # self.offset_convolution = nn.Conv1d(
...
#         # torch.nn.init.constant_(self.offset_convolution.weight, 0.)
#         torch.nn.init.constant_(self.offset_dconv.weight, 0.)
#         torch.nn.init.constant_(self.offset_pconv.weight, 0.)

#         if bias:
#             # torch.nn.init.constant_(self.offset_convolution.bias, 1.)
...
#         # self.offset_convolution.register_backward_hook(self._set_lr)
